...
<body>
    ...
    <div class="container mt-5">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0"><b class="d-block d-md-inline">Search For Order, Feedback Details</b><a href="user_credentials.php" class="btn btn-danger float-md-end mt-2 mt-md-0">BACK</a></h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td class="col-md-5"><label for="uname" class="form-label">Username</label></td>
                                            <td class="col-md-7"><input type="text" name="uname" class="form-control" id="uname" required></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        if (isset($_POST['search'])) {
            $name = $_POST['uname'];
            $query = "SELECT feedback.*, user.* FROM feedback INNER JOIN user ON feedback.user_id = user.Id WHERE user.Username='$name' ORDER BY feedback.id ASC";
		...
		<h2 class="text-center">Feedback Details</h2><br>
            ...
            <?php
                ...
                echo "<div class='alert alert-warning text-center'><h5>No feedback records found</h5></div>";
            }?><br><?php
    $query2 = "SELECT `order`.*, user.* FROM `order` INNER JOIN user ON `order`.user_id = user.Id WHERE user.Username='$name' ORDER BY `order`.order_id ASC";
