    ...
    if ($month === '' || $year === '') {
        ...
        if ($check_table_result->num_rows > 0) {
            ...
            if ($result->num_rows > 0) {
                echo "<div id='piecerate-searchResults'>";
                echo "<ul id='piecerate-employeeList' class='list-group mt-3'>";
                ...
                echo "<button id='piecerate-displayButton' class='btn btn-primary'>Display Salary</button>";
                echo "</div>";
                // JavaScript to handle display button
                echo "<script>
                        document.getElementById('piecerate-displayButton').addEventListener('click', function() {
                            document.getElementById('piecerate-employeeList').style.display = 'none';
